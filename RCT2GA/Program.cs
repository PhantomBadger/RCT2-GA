...
namespace RCT2GA
{
    class Program
    {
        ...
        {
            Console.WriteLine(RideData.RCT2TrackElements.TrackElementPropertyMap[RideData.RCT2TrackElements.RCT2TrackElement.Flat].Displacement.Z);
        ...
        {
            RideData.RCT2RideData testCoaster = GenerateTestCoaster2();
        ...
        static RideData.RCT2RideData GenerateTestCoaster2()
        {
